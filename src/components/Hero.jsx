...
const Hero = () => {
  return (
    <>
      <section id='home' className='wholePg relative flex items-center justify-center pt-16 pb-20
      border-b-[4px] border-transparent bg-gradient-to-r from-black via-[#04ff00] to-black'>
        ...
        <div className="absolute inset-0 bg-[url('./assets/limebg.jpg')] bg-no-repeat bg-cover">
          ...
          <div className="layout relative z-10 max-w-6xl mx-auto flex flex-col sm:flex-col md:flex-row items-center justify-between gap-8 px-6 py-24">
            ...
            {/* Image Column */}
            <div className='flex-1 flex justify-center sm:mt-[12rem] lg:mt-[5rem] md:justify-end'>
              <img
                src={selfiebw}
                alt="O'marr Reid"
