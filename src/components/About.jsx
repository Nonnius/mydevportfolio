...
const About = () => {
  return (
    <div className="absolute inset-0 bg-[url('./assets/limebg.jpg')] h-screen bg-no-repeat bg-cover">
       ...
       {/*Page Title section*/}
       <div className="pgTitle text-center s24Ultra1:mt-[4rem] bg-gradient-to-l from-black to-[#046502]
        ...
        <div className="aboutCard grid grid-cols-1 s24Ultra2:grid-cols-2 gap-4 min-h-[65px] mx-auto max-w-6xl p-6 rounded-lg">
